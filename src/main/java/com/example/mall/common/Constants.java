...
public class Constants {
  //上传文件的默认url前缀，根据部署设置自行修改
    public final static String FILE_UPLOAD_DIC = "F:\\workspace\\shop\\058-ShoesShop\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static String ADMIN_ROLE = "admin";//管理员角色
